...
envsubst '${APP_SURFACE} ${API_BASE_URL} ${PAY_PUBLIC_BASE_URL} ${VITE_MOBI_SLON_URL} ${VITE_MOBI_SLON_CAMPAIGN_KEY} ${VITE_FB_PIXEL_ID} ${VITE_YANDEX_METRIKA_ID} ${VITE_TRACKING_DEBUG}' < "$TEMPLATE" > "$OUTPUT"
