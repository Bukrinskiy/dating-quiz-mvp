...
envsubst '${VITE_MOBI_SLON_URL} ${VITE_MOBI_SLON_CAMPAIGN_KEY} ${VITE_FB_PIXEL_ID} ${VITE_YANDEX_METRIKA_ID} ${VITE_TRACKING_DEBUG} ${VITE_TELEGRAM_BOT_URL}' < "$TEMPLATE" > "$OUTPUT"
