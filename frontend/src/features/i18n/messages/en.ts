...
export const enMessages: AppMessages = {
  ui: {
    ...
    payPlanQuarterlyTitle: "Quarterly plan",
    payBillingWeekly: "per week",
    payBillingMonthly: "per month",
    payBillingQuarterly: "per 3 months",
    payPerDay: "per day",
  ...
  hero: {
    title: "Stop wasting time comparing proxy services manually",
    subtitle: "In a few clicks we show where to find the right proxies for your task — by GEO, type, payment and price.",
    list: [
      "No empty sign-ups",
      "Fast shortlisting",
      "Fresh offers",
    ],
    note: "Selections are updated for current availability and offer conditions.",
    cta: "Pick proxies",
    microcopy: "No empty sign-ups • Fast shortlisting • Fresh offers",
    warnings: ["404 Not Found", "No Stock", "Payment Failed", "Only after registration"],
    checks: [
      "GEO: Kazakhstan",
      "Type: Mobile",
      "Payment: Crypto",
